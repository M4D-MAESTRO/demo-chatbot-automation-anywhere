...
import { QuestionImovelModule } from '../../../utils/dialogs/question-imovel/question-imovel.module';
...
@NgModule({
  ...
  imports: [
    ...
    QuestionImovelModule,
  ],
  exports: [EncomendaCadastroComponent,],
})
export class EncomendaCadastroModule { }
